...
import type { Quotation } from "@/redux/api/projectsApi";
...
import steelLogo from "@/assets/logo.png";
import slide1Img from "@/assets/quotation/images/slide-1.png";
import slide2Img from "@/assets/quotation/images/slide-2.png";

import slide3BgImg from "@/assets/quotation/images/slide-3-bg.png";
import slide3PatternImg from "@/assets/quotation/images/slide-3-pattern.png";

import slide4Img from "@/assets/quotation/images/slide-4.png";
import slide5Img from "@/assets/quotation/images/slide-5.png";
import slide6Img from "@/assets/quotation/images/slide-6.png";

import slide8Img from "@/assets/quotation/images/slide-8.png";

// icons for slide 3
import mapPinIcon from "@/assets/quotation/icons/map-pin.svg";
import notepadIcon from "@/assets/quotation/icons/notepad.svg";
import targetIcon from "@/assets/quotation/icons/target.svg";

// icons for slide 4
// fit-width,length,eave,slope,area
import fitWidthIcon from "@/assets/quotation/icons/fit-width.svg";
import lengthIcon from "@/assets/quotation/icons/length.svg";
import eaveIcon from "@/assets/quotation/icons/eave.svg";
import sloeIcon from "@/assets/quotation/icons/slope.svg";
import areaIcon from "@/assets/quotation/icons/area.svg";

// icons for slide 5
// live-load,snow-load,dead-load,wind-velocity,exposure,seismic-zone,seismic-coefficient
import liveLoadIcon from "@/assets/quotation/icons/live-load.svg";
import snowLoadIcon from "@/assets/quotation/icons/snow-load.svg";
import deadLoadIcon from "@/assets/quotation/icons/dead-load.svg";
import windVelocityIcon from "@/assets/quotation/icons/wind-velocity.svg";
import exposureIcon from "@/assets/quotation/icons/exposure.svg";
import seismicZoneIcon from "@/assets/quotation/icons/seismic-zone.svg";
import seismicCoefficientIcon from "@/assets/quotation/icons/seismic-coefficient.svg";
...
interface ExtendedQuotation extends Quotation {
  ...
  doorSize?: string;
  doorQty?: number | string;
  personnelDoorSize?: string;
  personnelDoorQty?: number | string;
  leftEaveHeight?: number | string;
  rightEaveHeight?: number | string;
  preparedBy?: string;
  roofSlope?: string;
  endwallType?: string;
  roofPanel?: string;
        ...
        <div className="absolute left-[6.5%] top-[8%] w-[42%] h-[84%] flex flex-col z-10">
          ...
          <div className="border border-slate-350 rounded-xl overflow-hidden bg-white w-full mt-6 md:mt-8 shadow-[0_1px_3px_0_rgba(0,0,0,0.05)]">
            {buildingDetailConfigs.map((config, index) => (
              <div
                key={config.key}
                className={`flex items-center justify-between py-2 md:py-3 lg:py-3.5 px-4 ${index < buildingDetailConfigs.length - 1
        ...
        <div className="absolute left-[6.5%] top-[8%] w-[42%] h-[84%] flex flex-col z-10">
          ...
          <div className="border border-slate-350 rounded-xl overflow-hidden bg-white w-full mt-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.05)]">
            {designLoadConfigs.map((config, index) => (
              <div
                key={config.key}
                className={`flex items-center justify-between py-1.5 md:py-2 lg:py-2.5 px-4 ${index < designLoadConfigs.length - 1
                    ? "border-b border-slate-200"
                    : ""
                  }`}
              >
            ...
            <div className="border border-slate-300 rounded-xl overflow-hidden bg-white shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] w-full">
              ...
              <div className="flex flex-col">
                {panelConfigs.map((config, idx) => (
                  <div
                    key={config.key}
                    className={`flex items-center justify-between py-2 md:py-3 px-4 text-xs md:text-sm font-lato ${idx < panelConfigs.length - 1
                        ? "border-b border-slate-200"
                        : ""
                      }`}
                  >
              ...
              <div className="border border-slate-300 rounded-xl overflow-hidden bg-white shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] w-full">
                ...
                <div className="flex flex-col">
                  {insulationConfigs.map((config, idx) => (
                    <div
                      key={config.key}
                      className={`flex items-center justify-between py-2 md:py-3 px-4 text-xs md:text-sm font-lato ${idx < insulationConfigs.length - 1
                          ? "border-b border-slate-200"
                          : ""
                        }`}
                    >
              ...
              <div className="border border-slate-300 rounded-xl overflow-hidden bg-white shadow-[0_1px_3px_0_rgba(0,0,0,0.05)] w-full">
                ...
                <div className="flex flex-col">
                  {gutterConfigs.map((config, idx) => (
                    <div
                      key={config.key}
                      className={`flex items-center justify-between py-2 md:py-3 px-4 text-xs md:text-sm font-lato ${idx < gutterConfigs.length - 1
                          ? "border-b border-slate-200"
                          : ""
                        }`}
                    >
        ...
        <div className="absolute left-[6.5%] top-[8%] w-[42%] h-[84%] flex flex-col z-10">
          ...
          <div className="border border-slate-350 rounded-xl overflow-hidden bg-white w-full mt-6 shadow-[0_1px_3px_0_rgba(0,0,0,0.05)]">
            {materialConfigs.map((config, idx) => (
              <div
                key={config.key}
                className={`flex items-center justify-between py-2 md:py-2.5 lg:py-3 px-4 ${idx < materialConfigs.length - 1
                    ? "border-b border-slate-200"
                    : ""
                  }`}
              >
            ...
            <div className="flex-1 flex flex-col gap-1.5 md:gap-2">
              ...
              <div className="border border-slate-300 rounded-xl overflow-hidden bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] w-full">
                ...
                {cogsTableData.map((row, idx) => (
                  <div
                    key={row.description}
                    className={`grid grid-cols-[1.5fr_1fr] text-[11px] md:text-xs lg:text-sm font-lato px-4 py-2 ${idx === 2
          ...
          <div className="flex flex-col gap-1.5 md:gap-2 mt-4 md:mt-6">
            ...
            <div className="border border-slate-300 rounded-xl overflow-hidden bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] w-full">
              ...
              {quotationData.pricing.pricingSummaryTable.map((row, idx) => (
                <div
                  key={row.description}
                  className={`grid grid-cols-[1.8fr_1fr_1fr_1.4fr] text-[11px] md:text-xs lg:text-sm font-lato px-4 py-2.5 divide-x ${idx === 2
            ...
            <div className="flex-1 flex flex-col gap-2">
              ...
              <div className="border border-slate-300 rounded-xl overflow-hidden bg-white shadow-[0_1px_2px_0_rgba(0,0,0,0.05)] w-full">
                ...
                {doorsTableData.map((row, idx) => (
                  <div
                    key={idx}
                    className={`grid grid-cols-[1.5fr_1.2fr_0.8fr_0.8fr] text-[11px] md:text-xs lg:text-sm font-lato font-bold text-slate-700 px-4 py-1.5 md:py-2 ${idx < doorsTableData.length - 1
                        ? "border-b border-slate-200"
                        : ""
                      }`}
                  >
