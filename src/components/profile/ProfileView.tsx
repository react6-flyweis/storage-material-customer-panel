  ...
  return (
    <div className="p-5 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between mt-2 xl:mt-0">
        ...
        }} className=" md:px-4 ml-auto lg:mt-2 mt-4 py-2.5 bg-(--button-bg-primary-color) text-white rounded-lg hover:opacity-90 transition-opacity md:text-sm text-xs font-normal min-w-[128px] w-fit">
          Save All Changes
        </button>
      </div>
