...
const SettingsView: React.FC<SettingsViewProps> = () => {
  ...
  return (
    <div className="p-5 space-y-6">
      ...
      <div className="flex flex-wrap items-center justify-between">
        ...
        <button
          onClick={() => {
            ...
            setModalTitle("Settings Saved Successfully");
            setTimeout(() => {
              setIsSuccessModalOpen(false);
            }, 3000);
          }}
          className="md:px-4 ml-auto md:mt-0 mt-4 py-2.5 bg-(--button-bg-primary-color) text-white rounded-lg hover:opacity-90 transition-opacity md:text-sm text-xs font-normal min-w-[128px] w-fit"
        >
          Save All Settings
        </button>
      </div>
      ...
      {/* Account Settings */}
      <h3 className="md:text-lg font-bold text-black mb-3">Account Settings</h3>
      <div className="bg-white rounded-xl p-6 border border-gray-100 space-y-6">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className={`relative inline-flex md:h-6 md:w-11 w-11 h-5.5 items-center rounded-full transition-colors ${
      ...
      <h3 className="md:text-lg font-bold text-black mb-3">
        Notification Settings
      </h3>
      <div className="bg-white rounded-xl p-6 border border-gray-100 space-y-6">
